...
namespace MARDEK.UI
{
     public class Path : MonoBehaviour
     {
          ...
          [SerializeField] MapWaypoint point1;
          [SerializeField] MapWaypoint point2;
          ...
          public Vector2 DirectionFrom(MapWaypoint waypoint)
          {
          ...
          public MapWaypoint GetOther(MapWaypoint waypoint)
          {
